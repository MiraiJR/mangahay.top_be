...
@Module({
  ...
  controllers: [],
  providers: [JwtAdapterService, JwtService, MailService, S3Service, OAuth2Service, CrawlerService],
  exports: [JwtAdapterService, JwtService, MailService, S3Service, OAuth2Service, CrawlerService],
})
